...
All notable changes to this asset library are documented here.

## Unreleased

### Added

- Root contributor documentation and a changelog policy.
- Brand-system reference extracted from the static blog homepage template.
...
- Documented catalog, naming, and cross-reference requirements in repository instructions.
